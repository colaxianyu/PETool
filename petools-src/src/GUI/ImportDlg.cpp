...
namespace petools::gui {
    ...
    void ImportDlg::InitDialog() noexcept {
  //      init_main_list();
		//init_function_list();
    }

    void ImportDlg::ShowDialog() noexcept {
    ...
    LRESULT ImportDlg::HandleMessage(const WindowHandle& h_dlg, UINT message, WPARAM w_param, LPARAM l_param) {
